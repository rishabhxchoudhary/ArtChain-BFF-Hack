    ...
    <>
      <div>
        ...
        <div className="cards flex gap-9 justify-center w-screen h-full flex-wrap p-10 lg:justify-start lg:ml-10">
          ...
          {!result.fetching && !result.error && result.data.arts.length != 0 ? (
      ...
      {selectedNFT && (
        <div
          onClick={outerModalRef}
          className="modal text-black flex items-center justify-center fixed top-0 left-0 w-screen h-screen"
        >
          <div
            onClick={innerModalRef}
            className="modal-content p-10 border rounded bg-white max-w-lg w-screen"
          >
